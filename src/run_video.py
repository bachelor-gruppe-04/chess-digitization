...
import asyncio
from logic.detection.find import find_corners
...
async def main() -> None:
    video_path: str = 'resources/videos/chessvideo.mp4'
    output_path: str = 'resources/videos/output_video_combined.avi'

    piece_model_path: str = "src/logic/models/480M_leyolo_pieces.onnx"
    corner_model_path: str = "src/logic/models/480L_leyolo_xcorners.onnx"
